                ...
                <div className="lg:col-span-2">
                  <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-2">
                    <div className="md:col-span-2">
                      <label className="text-[#323232]-600" htmlFor="full_name">Name</label>
                      <input
                        type="text"
                        name="full_name"
                        id="full_name"
                    ...
                    <div className="md:col-span-2">
                      <label className="text-[#323232]-400" htmlFor="bio">Bio</label>
                      <textarea
                        name="bio"
                        id="bio"
                    ...
                    <div>
                      <label className="text-[#323232]-400" htmlFor="phone">Phone Number</label>
                      <input
                        type="text"
                        name="phone"
                        id="phone"
                    ...
                    <div>
                      <label className="text-[#323232]-400" htmlFor="age">Age</label>
                      <input
                        type="number"
                        name="age"
                        id="age"
                    ...
                    <div>
                      <label className="text-[#323232]-400" htmlFor="gender">Gender</label>
                      <select
                        name="gender"
                        id="gender"
                    ...
                    <div>
                      <label className="text-[#323232]-400" htmlFor="degree">Specialization</label>
                      <input
                        type="text"
                        name="degree"
                        id="degree"
                    ...
                    <div>
                      <label className="text-[#323232]-400" htmlFor="fees">Fees</label>
                      <input
                        type="number"
                        name="fees"
                        id="fees"
                    ...
                    {/* Address Fields */}
                    <div className="md:col-span-2">
                      <label className="text-[#323232]-400" htmlFor="street">Street Address</label>
                      <input
                        type="text"
                        name="street"
                        id="street"
                    ...
                    <div>
                      <label className="text-[#323232]-400" htmlFor="city">City</label>
                      <input
                        type="text"
                        name="city"
                        id="city"
                    ...
                    <div>
                      <label className="text-[#323232]-400" htmlFor="state">State</label>
                      <input
                        type="text"
                        name="state"
                        id="state"
                  ...
                  <button
                    type="button"
                    className="mt-6 mb-4 w-full py-2 text-white bg-blue-600 rounded-md hover:bg-blue-700"
