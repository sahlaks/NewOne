...
import ParentFeedbackModal from "../../../Components/Review/ReviewAndRating";
...
const ParentAppointmentDetails = () => {
  ...
  const handleReview = async (feedback) => {
    ...
    if (!trimmedReview) {
      toast.error("Feedback cannot be empty. Please provide your review.");
      return;
    }
        ...
        <div className="bg-[#FAF5E9] min-h-screen flex flex-col items-center pt-16 px-4">
          ...
          <div className="w-full md:w-3/4 lg:w-2/3 bg-[#E3D7CD] rounded-lg shadow-md p-6 mb-10">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-2xl font-semibold text-[#323232]">
                Appointment Overview
              </h2>
              <button
                className="px-4 py-2 bg-[#323232] text-white font-semibold rounded shadow hover:bg-black transition-all"
            ...
            <div className="flex justify-between mb-4">
              ...
              <p
                className={`${getStatusColor(appointment?.appointmentStatus)} font-semibold`}
              >
                Status: {appointment?.appointmentStatus}
              </p>
            </div>
            <h2 className="text-xl font-semibold text-[#323232] mt-6">
              Patient Information
            </h2>
          ...
          {appointment?.prescription && prescriptions.length > 0 ? (
            <div className="w-full md:w-3/4 lg:w-2/3 bg-[#E3D7CD] rounded-lg shadow-md p-6 mb-10">
              <h2 className="text-xl font-semibold text-[#323232] mb-4">
                Prescription
              </h2>
